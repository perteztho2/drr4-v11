...
const WeatherForecastWidget = () => {
  ...
  return (
    <div className={`bg-gradient-to-r from-white via-blue-50 to-white border-t-2 border-gray-300 border-b-2 border-gray-300 py-4 shadow-lg transition-all duration-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
      <div className="container mx-auto px-4">
        {/* Header */}
