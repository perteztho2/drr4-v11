        ...
        <div className="container mx-auto px-4 z-30 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-6 mb-6 md:mb-9 px-4 animate-slide-up stagger-3">
            ...
            <button
              ...
              className="inline-flex items-center px-6 md:px-12 py-4 md:py-6 bg-gradient-to-r from-yellow-500 to-yellow-600 text-blue-950 font-bold rounded-full shadow-xl md:shadow-2xl hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl md:hover:shadow-3xl active:scale-60 text-sm md:text-xl animate-pulse-glow"
            >
