    ...
    <section id="home" className="relative h-screen flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center relative">
        ...
        <div className="container mx-auto px-4 z-30 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 md:gap-6 mb-20 md:mb-20 px-4 animate-slide-up stagger-3">
            <button
        ...
        {/* Scroll Indicator */}
        <div className="hidden absolute bottom-16 md:bottom-20 left-0 right-0 flex justify-center z-30 animate-bounce">
          <button
