    ...
    <section id="emergency-procedures" className="py-12 md:py-24 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        ...
        <div className={`text-center mb-8 md:mb-16 ${isVisible ? 'animate-fadeIn' : 'opacity-0'}`}>
          ...
          <h2 className="text-2xl md:text-2xl lg:text-5xl xl:text-6xl font-bold bg-gradient-to-r from-gray-900 via-blue-900 to-gray-900 bg-clip-text text-transparent mb-4 md:mb-6">
