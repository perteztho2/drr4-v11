...
const Navigation = () => {
  ...
  const renderItem = (item: any, mobile = false) => {
    ...
    const activeClasses = active
      ...
      : "text-black/90 hover:bg-white/10 hover:text-yellow-500 backdrop-blur-sm";
          ...
          {open && (
            <div
              className={
                mobile
                  ? "ml-4 mt-2 space-y-1"
                  : "absolute top-full left-0 mt-2 text-black w-56 bg-red/100 backdrop-blur-xl rounded-2xl shadow-2xl py-3 z-50 border border-white/20"
              }
            >
