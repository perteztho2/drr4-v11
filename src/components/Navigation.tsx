          ...
          <div className="flex items-center justify-between h-20">
            ...
            <div className="hidden lg:flex items-center space-x-2">
              ...
              <button
                ...
                className="flex items-center px-2 py-3 rounded-xl text-sm font-small text-white/90 hover:bg-white/10 hover:text-white transition-all duration-300 hover:transform hover:scale-105 backdrop-blur-sm group"
              >
